      ...
      <main className="h-full px-4 py-12 lg:pl-72">
        <div className="w-full mx-auto mb-12 sm:px-6 lg:px-8 lg:w-10/12 xl:w-8/12">
          ...
          <p className="mb-8 text-center text-gray-400">
            This form enables you to burn tokens from an existing Solana
            blockchain token. Specify the quantity to permanently remove and
            provide the required permissions. This process decreases the token's
            total supply, potentially increasing its scarcity and value.
          </p>
